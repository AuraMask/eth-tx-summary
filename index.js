...
const createRpcVm = require('icjs-vm/dist/hooked').fromWebuProvider;
const ircUtil = require('icjs-util');
// using local copy pending https://github.com/icjs/icjs-block/pull/24
const materializeBlock = require('./materialize-blocks');
// const materializeBlock = require('icjs-block/from-rpc')
